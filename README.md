# TVBox - 日本のテレビ、その他公開LIVE放送がこれ1つで視聴可能
...
> ⚠ **TVBoxを維持するために安い海外の専用サーバーを活用していますが、それでも毎月$70(日本円で10000円)掛かっています。<br>
※6月からサーバーのダウンタイムと利用者が増えたのでサーバーをこれまでの倍にアップグレードして、毎月の維持費が$40から$70に増えました。<br>
...
誰でも世界中のどこでも(中国,イラン,ロシア等一部の国ではCDN側の制限有り)無料で使用でき、不快なポップアップ広告やウイルスの心配は一切ありません。

※バージョン毎に視聴できる番組を調整しています。

見れないチャンネル等その他の諸事情で削除されたチャンネルがあります。
...
※チャンネル追加リクエストは一切受け付けておらず、見つけ次第削除されます。

複数のインターネット接続環境(Wi-Fiやモバイルデータ通信等)と複数のデバイスで試した上で問題が起きるか確認してからissuesを開いてください。
...
使用しているソースは全て第三者によってGitHubやインターネット上で公開されているものです。
